...
public final class Microflows
{
	...
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder sUB_EmailAccount_UpdatePasswordBuilder(
		email_connector.proxies.EmailAccount_NPE _emailAccount_NPE,
		email_connector.proxies.EmailAccount _emailAccount
	)
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("Email_Connector.SUB_EmailAccount_UpdatePassword");
		builder = builder.withParam("EmailAccount_NPE", _emailAccount_NPE);
		builder = builder.withParam("EmailAccount", _emailAccount);
		return builder;
	}

	public static void sUB_EmailAccount_UpdatePassword(
		IContext context,
		email_connector.proxies.EmailAccount_NPE _emailAccount_NPE,
		email_connector.proxies.EmailAccount _emailAccount
	)
	{
		sUB_EmailAccount_UpdatePasswordBuilder(
				_emailAccount_NPE,
				_emailAccount
			)
			.execute(context);
	}
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder sUB_EmailAccount_UpdatePassword_RefreshBuilder(
		email_connector.proxies.EmailAccount_NPE _emailAccount_NPE,
		email_connector.proxies.EmailAccount _emailAccount
	)
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("Email_Connector.SUB_EmailAccount_UpdatePassword_Refresh");
		builder = builder.withParam("EmailAccount_NPE", _emailAccount_NPE);
		builder = builder.withParam("EmailAccount", _emailAccount);
		return builder;
	}

	public static void sUB_EmailAccount_UpdatePassword_Refresh(
		IContext context,
		email_connector.proxies.EmailAccount_NPE _emailAccount_NPE,
		email_connector.proxies.EmailAccount _emailAccount
	)
	{
		sUB_EmailAccount_UpdatePassword_RefreshBuilder(
				_emailAccount_NPE,
				_emailAccount
			)
			.execute(context);
	...
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder sUB_EmailTemplate_CreateBuilder(
		email_connector.proxies.EmailTemplate _emailTemplate,
		java.util.List<mxmodelreflection.proxies.Token> _newTokenList
	)
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("Email_Connector.SUB_EmailTemplate_Create");
		builder = builder.withParam("EmailTemplate", _emailTemplate);
		builder = builder.withParam("NewTokenList", _newTokenList);
		return builder;
	}

	public static email_connector.proxies.EmailTemplate sUB_EmailTemplate_Create(
		IContext context,
		email_connector.proxies.EmailTemplate _emailTemplate,
		java.util.List<mxmodelreflection.proxies.Token> _newTokenList
	)
	{
		Object result = sUB_EmailTemplate_CreateBuilder(
				_emailTemplate,
				_newTokenList
			)
			.execute(context);
		return result == null ? null : email_connector.proxies.EmailTemplate.initialize(context, (IMendixObject) result);
	}
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder sUB_EmailTemplate_UpdateBuilder(
		email_connector.proxies.EmailTemplate _emailTemplate,
		java.util.List<email_connector.proxies.Attachment> _attachmentList_New,
		email_connector.proxies.EmailTemplate _newEmailTemplate
	)
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("Email_Connector.SUB_EmailTemplate_Update");
		builder = builder.withParam("EmailTemplate", _emailTemplate);
		builder = builder.withParam("AttachmentList_New", _attachmentList_New);
		builder = builder.withParam("NewEmailTemplate", _newEmailTemplate);
		return builder;
	}

	public static void sUB_EmailTemplate_Update(
		IContext context,
		email_connector.proxies.EmailTemplate _emailTemplate,
		java.util.List<email_connector.proxies.Attachment> _attachmentList_New,
		email_connector.proxies.EmailTemplate _newEmailTemplate
	...
	{
		sUB_EmailTemplate_UpdateBuilder(
				_emailTemplate,
				_attachmentList_New,
				_newEmailTemplate
			)
